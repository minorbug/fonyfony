 ...
 */
class Edition extends \AppBundle\Entity\Edition implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Edition' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Edition' . "\0" . 'publication', 'name', 'publicationDate', '' . "\0" . 'AppBundle\\Entity\\Edition' . "\0" . 'pages');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Edition $proxy) {
    ...
    public function addPage(\AppBundle\Entity\Page $pages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPage', array($pages));
