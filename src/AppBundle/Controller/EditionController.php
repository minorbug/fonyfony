...
use AppBundle\Form\EditionType;
...
class EditionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Edition')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Edition:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Edition')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Edition:edit.html.twig")
     */
